...
public class Temp {
    ...
    public static void generateBitmap(double[][] matrix, CallBack_HeatMap callBack_heatMap) {
        ...
        LongRunningTask longRunningTask = new LongRunningTask(matrix, callBack_heatMap);
        taskRunner.executeAsync(longRunningTask, new TaskRunner.Callback<R>() {
            @Override
...
//        int[] colors = new int[]{
//                ContextCompat.getColor(context, R.color.heat0),
//                ContextCompat.getColor(context, R.color.heat1),
//                ContextCompat.getColor(context, R.color.heat2),
//                ContextCompat.getColor(context, R.color.heat3),
//                ContextCompat.getColor(context, R.color.heat4),
//                ContextCompat.getColor(context, R.color.heat5),
//                ContextCompat.getColor(context, R.color.heat6),
//                ContextCompat.getColor(context, R.color.heat7),
//                ContextCompat.getColor(context, R.color.heat8),
//                ContextCompat.getColor(context, R.color.heat9)
//        };
        ...
        while (row < HEIGHT) {
            while (column < WIDTH) {
                ...
                image.setPixel(column, row, Color.HSVToColor(new float[]{(float) (220.0 * val), 1.0f, 1.0f}));
                column++;
            }
            row++;
            column = 0;
    ...
    static class LongRunningTask implements Callable<R> {

        private double[][] matrix;
        private CallBack_HeatMap callBack_heatMap;

        public LongRunningTask(double[][] matrix, CallBack_HeatMap callBack_heatMap) {
            this.matrix = matrix;
            this.callBack_heatMap = callBack_heatMap;
        }
